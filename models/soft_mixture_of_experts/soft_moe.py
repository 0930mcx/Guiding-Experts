...
from models.MyLoss import  AuxLoss
...
class SoftMoE(nn.Module):
    ...
    def forward(self, x: Tensor, masks, is_front: bool) :
        ...
        if masks is not None and self.index == 7:
            aux = AuxLoss()
            is_front=True
            loss = aux(dispatch_weights, masks, is_front)
        return x, loss
